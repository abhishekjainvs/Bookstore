...
<div id="carouselBlk">
	<div id="myCarousel" class="carousel slide">
		<div class="carousel-inner">
		  ...
		  <div class="container">
			<a href="special_offer.php"><img style="width:100%" src="themes/images/carousel/9.png" alt="special offers"/></a>
		  ...
		  for($i=10;$i<16;$i++)
		  {
			  echo"<div class='item'>
		  <div class='container'>
			<a href='special_offer.php'><img style='width:100%' src='themes/images/carousel/$i.png' alt=''/></a>
		  </div>
		  </div>
		  ";
		  }
...
<!-- Sidebar end=============================================== -->
		<div class="span9">		
			...
			$con=mysqli_connect("localhost","root","","ecommerce");
			$val=mysqli_query($con,"select count(*) as `total` from `product`");
			$data=mysqli_fetch_object($val);
			echo"<h4>Featured Products <small class='pull-right'>$data->total+ featured products</small></h4>";
			...
			<div class="carousel-inner">
			  ...
			  <ul class="thumbnails">
				...
				$con=mysqli_connect("localhost","root","","ecommerce");
				$res=mysqli_query($con,"select * from `product` where `id`<5");
				...
				while($val=mysqli_fetch_array($res))
			{
				...
				echo"<li class='span3'>
				  <div class='thumbnail'>
				  <i class='tag'></i>
					<a href='product_details.php?cata=$val[0]'><img src='$val[12]' alt=''></a>
					<div class='caption'>
					  <h5>$val[1]</h5>
					  <h4><a class='btn' href='product_details.php?cata=$val[0]'>VIEW</a> <span class='pull-right'>Rs.$val[3]</span></h4>
					</div>
				  </div>
				</li>";
			...
			?>
			  ...
			  <?php
				...
				$con=mysqli_connect("localhost","root","","ecommerce");
				$res=mysqli_query($con,"select * from `product`where `ID`>4 and `id`<10");
		...
		<h4>Latest Products </h4>
			  ...
			  <?php
				...
				$con=mysqli_connect("localhost","root","","ecommerce");
				$res=mysqli_query($con,"SELECT * FROM `product` ORDER BY `ID` desc limit 6");
