...
<div class="container">
	...
	<div class="row">
		...
		<p>	202 Preet Vihar,<br/> DELHI-32, INDIA
			<br/><br/>
			info@booksshop.com<br/>
			﻿Tel 123-456-6780<br/>
			Fax 123-456-6779<br/>
			web:booksshop.com
		</p>		
        ...
        <fieldset>
          <div class="control-group">
              ...
              <input type="text" placeholder="name" name="uname" class="input-xlarge" required/>
           
          </div>
		   <div class="control-group">
           
              <input type="text" placeholder="email" name="uemail" class="input-xlarge" required/>
          ...
          <div class="control-group">
            ...
            <button class="btn btn-large" name="submit" type="submit">Send Messages</button>
...
if(isset($_REQUEST["submit"]))
{
	if(isset($_SESSION["userid"]))
{
	//echo"<h3 style='text-align: center'>Action will be taken shortly!</h3>";
	echo"<script language>'javascript'> alert('Action will be taken shortly!')</script>";
