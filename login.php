		...
		<div class="span4">
			...
			<form>
			  <div class="control-group">
				...
				<div class="controls">
				  <input class="span3"  type="text" name="userid" id="inputEmail1" placeholder="Email">
				</div>
			  </div>
			  <div class="control-group">
			  ...
			  <div class="control-group">
				<div class="controls">
				  <button type="submit" name="sub" class="btn">Sign in</button> <a href="forgetpass.php">Forget password?</a>
				</div>
			  </div>
			</form>
		</div>
...
if(isset($_REQUEST["reg"]))
{
	...
	$con=mysqli_connect("localhost","root","","ecommerce");
	$query="insert into `user_detail`(`title`,`first_name`,`last_name`,`email`,`password`,`address_1`,`address_2`,`city`,`state`,`pincode`,`mobile_no`) values('$ti','$fn','$ln','$em','$pa','$a1','$a2','$ci','$st','$pi','$ph')";
